...
{
    public partial class CreateBioTemp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateSignaturePerson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateBio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Code90791 = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    DateAbuse = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonInvolved = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApproximateDateReport = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    HasTheClientVisitedPhysician_Date = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ForHowLong = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    AnyFood = table.Column<bool>(type: "bit", nullable: false),
                    AnyEating = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    MilitaryServiceHistory = table.Column<bool>(type: "bit", nullable: false),
                    MilitaryServiceHistory_Explain = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VocationalAssesment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IfSexuallyActive = table.Column<int>(type: "int", nullable: false),
                    ...
                    DateSignatureLicensedPractitioner = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateSignatureUnlicensedTherapist = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    DateSignatureSupervisor = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BioTemp", x => x.Id);
                });
        }
