...
{
    public partial class UpdateClient_IntakeAccessToServices : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "IntakeAccessToServices",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IntakeAccessToServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IntakeAccessToServices_Clients_Client_FK",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IntakeAccessToServices_Client_FK",
