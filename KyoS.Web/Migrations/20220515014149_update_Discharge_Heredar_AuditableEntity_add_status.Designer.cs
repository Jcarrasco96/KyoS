...
namespace KyoS.Web.Migrations
{
    ...
    [Migration("20220515014149_update_Discharge_Heredar_AuditableEntity_add_status")]
    partial class update_Discharge_Heredar_AuditableEntity_add_status
    {
            ...
            modelBuilder.Entity("KyoS.Web.Data.Entities.DischargeEntity", b =>
                {
                    b.HasOne("KyoS.Web.Data.Entities.ClientEntity", "Client")
                        .WithOne("Discharge")
                        .HasForeignKey("KyoS.Web.Data.Entities.DischargeEntity", "Client_FK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
