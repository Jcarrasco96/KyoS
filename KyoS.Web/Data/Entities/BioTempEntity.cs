...
{
    public class BioTempEntity
    {
        public int Id { get; set; }
        public string UserName { get; set; }
        public string Url { get; set; }
        
        public string DateSignaturePerson { get; set; }
        public string DateBio { get; set; }
        ...
        public string If6_Date { get; set; }
        ...
        public string DateSignatureLicensedPractitioner { get; set; }
        public string DateSignatureUnlicensedTherapist { get; set; }
        public bool IConcurWhitDiagnistic { get; set; }
        public string AlternativeDiagnosis { get; set; }
        public string DateSignatureSupervisor { get; set; }
    }
}
