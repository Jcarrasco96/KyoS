...
{
    public class TCMAssessmentTempEntity
    {
        ...
        public string DateOfOnSetPresentingProblem { get; set; }
        ...
        public string HoweverVisitScheduler { get; set; }        
        public string DateSignatureCaseManager { get; set; }        
        public string DateSignatureTCMSupervisor { get; set; }
