        ...
        public IActionResult Create(int id = 0)
        {
            ...
            if (user_logged.Clinic != null)
            {
                model = new TCMFarsFormViewModel
                {
                   ...
                   AnxietyScale = 0,
                   CognitiveScale = 0,
                   ContractorID = TCMClient.Client.Clinic.ProviderId,
                   Country = "13",
                   ...
                   MCOID = "",
                   MedicaidProviderID = TCMClient.Client.Clinic.ProviderId,
                   MedicaidRecipientID = TCMClient.Client.MedicaidID,
                   MedicalScale = 0,
                   M_GafScore = "",
                   ProviderId = TCMClient.Client.Clinic.ProviderId,
                   ...
                   ContID1 = TCMClient.Client.Clinic.ProviderId,
                   ContID2 = "",
                   ContID3 = "",
                   ProgramEvaluation = "",
