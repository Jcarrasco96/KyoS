    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    user = new UserEntity
                    {
                        ...
                        UserType = (model.RoleId == 1) ? UserType.Documents_Assistant : (model.RoleId == 2) ? UserType.Facilitator : (model.RoleId == 3) ? UserType.Supervisor : (model.RoleId == 4) ? UserType.CaseManager : (model.RoleId == 5) ? UserType.TCMSupervisor : (model.RoleId == 6) ? UserType.Manager : (model.RoleId == 7) ? UserType.Admin : (model.RoleId == 8) ? UserType.Frontdesk : UserType.Biller,
                        Active = model.Active,
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            EditViewModel model = new EditViewModel
            {
                ...
                RoleId = (user.UserType == UserType.Documents_Assistant) ? 1 : (user.UserType == UserType.Facilitator) ? 2 : (user.UserType == UserType.Supervisor) ? 3
                                                                     ...
                                                                     : (user.UserType == UserType.Manager) ? 6 : (user.UserType == UserType.Admin) ? 7 : (user.UserType == UserType.Frontdesk) ? 8 
                                                                     : (user.UserType == UserType.Biller) ? 9 : 0,
                Roles = _combosHelper.GetComboRoles(),
        ...
        public async Task<IActionResult> Edit(EditViewModel model)
        {
            if (ModelState.IsValid)
            {
                    ...
                    user.UserType = (model.RoleId == 1) ? UserType.Documents_Assistant : (model.RoleId == 2) ? UserType.Facilitator : (model.RoleId == 3) ? UserType.Supervisor : (model.RoleId == 4) ? UserType.CaseManager : (model.RoleId == 5) ? UserType.TCMSupervisor : (model.RoleId == 6) ? UserType.Manager : (model.RoleId == 7) ? UserType.Admin : (model.RoleId == 8) ? UserType.Frontdesk : UserType.Biller;
